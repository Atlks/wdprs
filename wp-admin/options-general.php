...
<tr>
<th scope="row"><label for="start_of_week">自动审核开关</label></th>
<td> 
<input type="radio" id="html" name="shenha" value="HTML" checked>
  <label for="html">开启</label>
  <input type="radio" id="css" name="shenha" value="CSS">
  <label for="css">关闭</label><br>
...
<tr>
<th scope="row"><label for="start_of_week">自动发布开关</label></th>
<td> 
<input type="radio" id="html" name="pubx" value="HTML" checked>
  <label for="html">开启</label>
  <input type="radio" id="css" name="pubx" value="CSS">
  <label for="css">关闭</label><br>
...
<tr>
<th scope="row"><label for="start_of_week">自动分享开关</label></th>
<td> 
<input type="radio" id="html" name="sharex" value="HTML" checked>
  <label for="html">开启</label>
  <input type="radio" id="css" name="sharex" value="CSS">
  <label for="css">关闭</label><br>
